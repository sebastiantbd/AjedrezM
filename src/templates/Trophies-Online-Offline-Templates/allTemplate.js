// Toda esta plantilla es la misma que la AuthenticatorAssertionResponse, sólo que esta plantilla es para los archivos que están dentro de carpetas, como lo son Tropies, Online y Offline
...
function changeInternetState(){
    ...
    if(navigator.onLine){
        ...
        new Noty({
            text: `<i class="fa fa-rss"></i> Conexión Perdida!`,
            theme: 'sunset',
            type: typeV,
            timeout: 1000,
            progressBar: true,
...
if(navigator.onLine){
    ...
    // esto sirve para agregar el nivel Online en la parte superior de las vistas de un jugador o multijugador si tiene conexión a internet
    document.querySelector('#OnlineLevel2').innerHTML = 
    `<div class="mainButton d-flex justify-content-center align-items-center pr-1 pl-1" style="margin-left: -20px; margin-top: 50px; border-width: 3px !important;">
