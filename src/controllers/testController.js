            ...
            function apagaPulsador(pulsador){
                ...
                if(indSec == secuencia.length){             // Si ya no queda secuencia, Nivel superado
                    ...
                    if(cantidadSecuencias === 3){
                        ...
                        Swal.fire({
                            title: 'Test Completado',
                            html: "Has completado los diferentes <strong>Tests</strong> Satisfactoriamente!<br> Ahora puedes pasar a jugar <strong><span class='text-success'>AjedrezM!</span><br><h4><strong>Bienvenido a esta aventura!</strong></h4> <i class='text-success fa fa-sign-out' style='font-size:2em;'></i></strong>",
                            icon: 'success',
                            showCloseButton: true,
                            showCancelButton: false,
                            showConfirmButton: false,
