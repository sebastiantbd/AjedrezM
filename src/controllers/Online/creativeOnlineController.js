...
$(document).ready(() => {
    ...
    $('#level1').click(() => {
        ...
        var check = setTimeout(() => {
            ...
            <div class="mainButton mt-2 p-2 d-flex justify-content-center flex-column align-items-center w-100" style="background: #ffedce !important;">
                <div class="w-50 d-flex justify-content-center align-items-center" style="background: white; height: 100px; overflow: hidden; border-radius: 25px !important; box-shadow: 0 0 10px 1px rgba(0,0,0,0.2);">
                    <img src="./../../../assets/creativeMode.jpg" class="w-100">
                </div>
                <p class="m-0 text-center mt-2" style='font-size: 0.8em;'>
                Puedes moverte libremente en el tablero y formar lo que desees, Derrota a tu contrincante realizando la mayor cantidad de figuras antes de <strong class='text-danger'>5 Minutos!</strong><br>
        ...
        // Aquí le decimos que en 20 segundos nos redirija a la vista de juego Creativo Online
        var run = setTimeout(() => {
            location.href = './../../views/Online/OnlineCreativeGame.html';            
        }, 20000);
