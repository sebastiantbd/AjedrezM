    ...
    $('#level1').click(() => {
        ...
        var check = setTimeout(() => {
            ...
            <div class="mainButton mt-2 p-2 d-flex justify-content-center flex-column align-items-center w-100" style="background: #ffedce !important;">
                <div class="w-50 d-flex justify-content-center align-items-center" style="background: white; height: 100px; overflow: hidden; border-radius: 25px !important; box-shadow: 0 0 10px 1px rgba(0,0,0,0.2);">
                    <img src="./../../../assets/angles/vectors.png" class="w-100">
                </div>
                <p class="m-0 text-center mt-2" style='font-size: 0.8em;'>
                -Traza una serie de vectores mediante saltos del caballo que se modelan en el tablero de gráficas con 9 saltos en serie del caballo, luego ubica las coordenadas del vector resultante.<br>
                -Las coordenadas serían: inicio <strong>(3,5)</strong>, llegada <strong>(8,3)</strong>.<br>
        ...
        // Aquí le decimos que en 20 segundos nos redirija a la vista de juego Educativo Online
        var run = setTimeout(() => {
            location.href = './../../views/Online/OnlineEducativeGame.html';            
        }, 20000);
